...
cdef class Bus:
    ...
    cdef void _hdma_reload(self, int ch) noexcept:
        ...
        self.hdma_do_transfer[ch] = self.hdma_active[ch]
    ...
    def load_ints(self, v):
        ...
        self.line_start = v[3]
        self.next_event = v[4]
        self.mul_shifter = v[5]
        self.mul_steps = v[6]
        self.mul_clock = v[7]
        self.vcount = v[8]
        self.field = v[9]
        self.frame = v[10]
        self.frame_ready = v[11]
        self.ticking = v[12]
        self.lines_per_frame = v[13]
        self.vblank_start = v[14]
        self.nmi_enabled = v[15]
        self.nmi_flag = v[16]
        self.nmi_pending = v[17]
        self.irq_mode = v[18]
        self.irq_flag = v[19]
        ...
        self.rd_mpy = v[34]
        self.wram_addr = v[35]
        self.auto_joypad = v[36]
        self.auto_joypad_busy = v[37]
        self.joypad_busy_until = v[38]
        self.pad_latched = v[39]
        self.hdma_enabled = v[40]
        self.dma_enabled = v[41]
        for i in range(6):
